...
const About = () => {
  ...
  const data = [
    {
      ...
      year: 2002,
      description:
        "Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro vero consectetur eveniet nulla suscipit minus quibusdam doloremque.",
      title: "Lorem",
      photourl: "assets/test2.png",
    },
    {
      id: 1,
      year: 2002,
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="w-full py-10 pb-[100px] flex-col justify-around items-center test">
